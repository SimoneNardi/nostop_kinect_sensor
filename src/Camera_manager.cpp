  ...
  // ROBOTS INITIAL POSE
	for(size_t i = 0; i<m_robot_initial_configuration.size(); ++i)
	{
		switch (m_robot_initial_configuration[i].pose_setted)
		{
			...
			case 1:
				m_robot_initial_configuration[i].initial_point_odom_SR.x = m_robot_initial_configuration[i].initial_pose_rect.x;
				m_robot_initial_configuration[i].initial_point_odom_SR.y = m_robot_initial_configuration[i].initial_pose_rect.y;
